...
const NewDM = () => {
    ...
    const selectNewContact = (contact) => {
        ...
        setSelectedChatData(contact); // set receiver
        setSearchContact([])
    }
        ...
        <>
            ...
            <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
                <DialogContent className='bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col rounded-md'>
                    ...
                    <div>
                        <Input placeholder="Search Contact" className='rounded-lg p-6 bg-[#2c2e3b] border-none' onChange={(e) => searchContact(e.target.value)} />
                    </div>
                    {
                        searchedContact.length > 0 && (
                            <ScrollArea className="h-[250px]">
                                <div className='flex flex-col gap-5'>
                                    {/* result list search contact */}
                    ...
                    {
                        searchedContact.length <= 0 && (
                            <div className='flex-1 md:flex flex-col mt-8 md:mt-0 justify-center items-center duration-1000 transition-all'>
