...
const MessageBar = () => {
    ...
    return (
        <div className='h-[10vh] min-h-[72px] bg-chat-surface border-t-2 border-chat-border flex flex-col justify-center px-6 md:px-10 mb-4 gap-2 transition-colors duration-300'>
            {replyToMessage && (
            ...
            <div className='flex justify-center items-center gap-4'>
                <div className='flex-1 flex bg-muted rounded-md items-center gap-4 pr-3 border border-border transition-shadow duration-200 focus-within:ring-1 focus-within:ring-[#8417ff]/40'>
                    <input type='text' className='flex-1 p-4 md:p-5 bg-transparent rounded-md focus:outline-none text-foreground placeholder:text-muted-foreground' placeholder='Enter message…' value={message}
                ...
                <button type="button" onClick={handleSendMessage} className="rounded-md flex items-center justify-center p-4 md:p-5 bg-[#8417ff] hover:bg-[#741bda] text-white transition-all duration-200 hover:brightness-110 active:scale-[0.98]">
