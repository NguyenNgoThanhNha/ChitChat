...
import { GET_CHANNELS_MESSAGES_ROUTE, GET_MESSAGE_ROUTE, HOST } from '@/utils/constant';
...
const MessageContainer = () => {
    ...
    const { selectedChatData, selectedChatType, selectedChatMessages, setselectedChatMessages, setDownLoading, setFileDownloadProgress, userInfo } = useAppStore();
                    ...
                    message.messageType === "file" && (
                        <div className={`${message.sender !== selectedChatData._id ?
                            ...
                            {checkIfImage(message.fileUrl) ?
                                ...
                                >
                                    <img src={`${HOST}/${message.fileUrl}`} alt={`${HOST}/${message.fileUrl}`} height={300} width={300}></img>
                                </div> :
